        ...
        <Panel title="Files to generate" bordered>
          <div className="space-y-3">
            ...
            <p className="text-xs text-text-faint">
              The HTML validation report is generated by the export route and lands
              with Phase 7&apos;s backend half — see docs/WORKSTREAMS.md.
            </p>
            ...
            <Button
              ...
              size="lg"
              block
              disabled={building || (!wantEote && !wantCsv)}
              onClick={() => void build({ eote: wantEote, csv: wantCsv })}
